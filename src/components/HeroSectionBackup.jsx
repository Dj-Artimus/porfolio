      ...
      },
      {
        content: (
          <HeroContentTemplate
            ...
            sHeading="I craft"
            bHeading="Responsive"
            mHeading="Pixel-Perfect, User-Centric Design"
          />
        ),
        image: (
          <HeroImageTemplate
      ...
      <div className="w-full sm:min-h-fit lg:min-h-max h-full flex flex-col-reverse lg:flex-row justify-center items-center bg-white dark:bg-black rounded-b-[8vw] sm:rounded-[4.5vw] lg:rounded-[2.5vw] shadow-sm shadow-gray-500 lg:shadow-gray-500 border-[3px] border-gray-600 overflow-hidden">
        ...
        >
          <div className="relative w-1/2 lg:justify-center items-center flex ms-[10vw] lg:ms-0">
            ...
            <div
              className="bor der w-[20vw] h-[40vh] left-[3vw] lg:w-[8vw]  lg:h-[60vh] rounded-full absolute  lg:left-[15%]"
          ...
          <motion.div
            className="lg:hidden flex flex-col flex-shrink-0 gap-[2%] sm:gap-[4%] justify-center w-1/2 h-full bor der relative border-blue-600"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="w-full h-1/2 sm:h-[50vh] sm:min-h-72 md:min-h-[320px] lg:min-h-max lg:h-full flex flex-col sm:flex-shrink flex-shrink-0 justify-end lg:justify-center bo rder border-red-500 relative">
